# Sentiments Evoked by WHO Public Health Posts during COVID-19 Pandemic: A Neural Network based Machine learning Analysis - [PATHAK et al.](https://www.cureus.com/articles/73888-sentiments-evoked-by-who-public-health-posts-during-the-covid-19-pandemic-a-neural-network-based-machine-learning-analysis)
...
- ```data``` folder contains the comments used to perform sentiment analysis
